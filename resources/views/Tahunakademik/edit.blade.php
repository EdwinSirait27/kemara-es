                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <select name="kurikulum_id" id="kurikulum_id" class="form-select">
                                            ...
                                            <option value="{{ $kurs->id }}" {{ $tahunakademik->kurikulum_id == $kurs->id ? 'selected' : '' }}>
                                                {{ $kurs->id }} - {{ $kurs->kurikulum }}
                                            </option>
                                        @endforeach
                                        </select>
                                        @error('kurikulum_id')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="numeric" class="form-control" id="tahunakademik"
                                        name="tahunakademik"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div>
                                        ...
                                        value="{{ old('tanggalakhir', $tahunakademik->tanggalakhir) }}" required
                                         maxlength="4">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="status" class="form-control-label">
                                        <i class="fas fa-lock"></i> {{ __('Pilih Status') }}
                                    </label>
                                    <div>
