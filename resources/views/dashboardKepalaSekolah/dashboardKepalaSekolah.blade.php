                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="d-flex flex-column h-100">
                                <h5 class="font-weight-bolder">Kemara-ES | Dashboard Kepala Sekolah</h5>
    ...
    <div class="row mt-4">
        <div class="col-lg-5 mb-lg-0 mb-4">
            <div class="card z-index-2">
                <div class="card-body p-3">
                    <!-- Bagian yang diganti -->
                    <div class="border-radius-lg py-3 pe-1 mb-1">
                        {{-- <div class="card-body"> --}}
                        ...
                        <form action="{{ route('dashboardKepalaSekolah.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-4">
                    <h6><i class="fas fa-user-shield"></i> Upload File Pengumuman</h6>
                    <label for="pengumuman" class="form-label"></label>

                                <input type="file" class="form-control" id="pengumuman" name="pengumuman" >
                                @error('pengumuman')
                            ...
                            {{-- <div class="mb-4">
                                ...
                                <input type="text" class="form-control" id="deskripsi" name="deskripsi" maxlength="50"
                                    required>
                                @error('deskripsi')
                                    <div style="color: red;">{{ $message }}</div>
                                @enderror
                    ...
                    {{-- <h6 class="ms-2 mt-4 mb-0"> Presentase Siswa Berdasarkan Agama </h6> --}}
