...
@section('title', 'Kesuma-GO | Edit Profile SU')
    ...
    <div>
        <div class="container-fluid">
            <div class="page-header min-height-300 border-radius-xl mt-4"
                style="background-image: url('../assets/img/curved-images/white-curved.jpg'); background-position-y: 50%;">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="Username" class="form-control-label">{{ __('Full Name') }}</label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="@error('Nama')border border-danger rounded-3 @enderror">
                                    @if ($guru->isNotEmpty())
                                        ...
                                        @foreach ($guru as $item)
                                            <input class="form-control" value="{{ $item->Nama }}" type="text"
       ...
       {{-- <div class="modal fade" id="imageModal" tabindex="-1" aria-labelledby="imageModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <iframe id="imageIframe" src="" frameborder="0" style="width: 100%; height: 800px;"></iframe>
                </div>
            </div>
        </div>
    </div
