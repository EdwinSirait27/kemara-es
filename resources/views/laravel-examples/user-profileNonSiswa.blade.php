                ...
                <div class="row gx-4">
                    <div class="col-auto">
                        <div class="avatar avatar-xl position-relative">
                            <form action={{ route('user-profileNonSiswa.store') }} method="POST" role="form text-left"
            ...
            <div class="card">
                ...
                <div class="card-body pt-4 p-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="NomorTelephoneAyah" class="form-control-label">{{ __('Nomor Telephone Ayah') }}</label>
                                <div class="@error('NomorTelephoneAyah')border border-danger rounded-3 @enderror">
                                    <input class="form-control"
                                        value="{{ e(optional(auth()->user())->Siswa->NomorTelephoneAyah ?? '') }}" type="text"
                                        id="NomorTelephoneAyah" name="NomorTelephoneAyah" aria-describedby="info-Alamat"
                                        maxlength="50" required>
