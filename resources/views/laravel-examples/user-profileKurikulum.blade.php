                ...
                <div class="row gx-4">
                    <div class="col-auto">
                        <div class="avatar avatar-xl position-relative">
                            <form action={{ route('user-profileKurikulum.store') }} method="POST" role="form text-left"
                            ...
                            <div class="form-group">
                                ...
                                <div class="@error('NipNips')border border-danger rounded-3 @enderror">
                                    ...
                                    @error('NipNips')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                                    <p class="text-muted text-xs mt-2">Masukkan NIP anda, hanya diperbolehkan angka saja,
                                        jika tidak ada silahkan isi dengan 0.</p>
                            ...
                            <div class="form-group">
                                ...
                                <div class="@error('Nuptk')border border-danger rounded-3 @enderror">
                                    ...
                                    @error('Nuptk')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                                    <p class="text-muted text-xs mt-2">Masukkan NUPTK anda, hanya diperbolehkan angka saja,
                                        jika tidak ada silahkan isi dengan 0.</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="@error('Nik')border border-danger rounded-3 @enderror">
                                    ...
                                    @error('Nik')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                                    <p class="text-muted text-xs mt-2">Masukkan Nik anda, hanya diperbolehkan angka saja,
                                        jika tidak ada silahkan isi dengan 0.</p>
                            ...
                            <div class="form-group">
                                ...
                                <div class="@error('Npwp')border border-danger rounded-3 @enderror">
                                    ...
                                    @error('Npwp')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                                    <p class="text-muted text-xs mt-2">Masukkan NPWP anda, hanya diperbolehkan angka saja,
                                        jika tidak ada silahkan isi dengan 0.</p>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('NomorSertifikatPendidik')border border-danger rounded-3 @enderror">
                                    <input class="form-control"
                                        value="{{ e(optional(auth()->user())->Guru->NomorSertifikatPendidik ?? '') }}"
                                    ...
                                    @error('NomorSertifikatPendidik')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                                    <p class="text-muted text-xs mt-2">Masukkan NSP anda, hanya diperbolehkan angka saja,
                                        jika tidak ada silahkan isi dengan 0.</p>
                            ...
                            <div class="form-group">
                                ...
                                <div class="@error('jadwalkenaikangaji') border border-danger rounded-3 @enderror">
                                    <input class="form-control"
                                        ...
                                        name="jadwalkenaikangaji" readonly>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('PendidikanAkhir')border border-danger rounded-3 @enderror">
                                    <input class="form-control"
                                        value="{{ e(optional(auth()->user())->Guru->PendidikanAkhir ?? '') }}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="@error('Jurusan')border border-danger rounded-3 @enderror">
                                    ...
                                    @error('Jurusan')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                                    <p class="text-muted text-xs mt-2">Masukkan Jurusan anda, contoh : Teknologi Informasi.
                                    </p>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('TugasMengajar')border border-danger rounded-3 @enderror">
                                    <input class="form-control"
                                        value="{{ e(optional(auth()->user())->Guru->TugasMengajar ?? '') }}"
                                        type="text" id="TugasMengajar" name="TugasMengajar"
                                        aria-describedby="info-TugasMengajar" maxlength="50" required>
                                    @error('TugasMengajar')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                                    <p class="text-muted text-xs mt-2">Masukkan TM anda, contoh : Ilmu Pengetahuan Sosial.
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="@error('jadwalkenaikanpangkat') border border-danger rounded-3 @enderror">
                                    <input class="form-control"
                                        ...
                                        name="jadwalkenaikanpangkat" readonly>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('NomorTelephone')border border-danger rounded-3 @enderror">
                                    <input class="form-control"
                                        value="{{ e(optional(auth()->user())->Guru->NomorTelephone ?? '') }}"
                                    ...
                                    @error('NomorTelephone')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                                    <p class="text-muted text-xs mt-2">Masukkan NT anda, hanya diperbolehkan angka saja,
                                        contoh : 08234723742.</p>
                                </div>
                            </div>
                        </div>
                    </div>
