                            ...
                            <div class="form-group">
                                ...
                                <div class="@error('Nama')border border-danger rounded-3 @enderror">
                                    ...
                                    <input class="form-control" 
                                           value="{{ auth()->user()->guru->Nama ?? 'Tidak Ada Data' }}" 
                                           type="text" 
                                           placeholder="Nama" 
                                           id="Nama" 
                                           name="Nama" 
                                           oninput="this.value = this.value.replace(/[^A-Za-z\s]/g, '');"maxlength="50" required>
                                           @error('Nama')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
                                @else
                                ...
                                <div class="@error('TempatLahir')border border-danger rounded-3 @enderror">
                                    @if (auth()->check() && auth()->user()->guru && auth()->user()->guru->TempatLahir)
                                        <input class="form-control" value="{{ auth()->user()->guru->TempatLahir }}"
                                            type="text" placeholder="TempatLahir" id="TempatLahir"
                                            name="TempatLahir" oninput="this.value = this.value.replace(/[^A-Za-z\s]/g, '');"maxlength="50" required>
                                        @error('TempatLahir')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
                                    @else
                                    ...
                                    @if (auth()->check() && auth()->user()->guru)
                                        <select class="form-control" name="JenisKelamin" id="JenisKelamin" required>
                                            ...
                                            <option value="Laki-Laki"
                                                {{ auth()->user()->guru->JenisKelamin == 'Laki-Laki' ? 'selected' : '' }}>
                                                Laki-Laki</option>
                                ...
                                <div class="@error('NipNips')border border-danger rounded-3 @enderror">
                                    @if (auth()->check() && auth()->user()->guru && auth()->user()->guru->NipNips)
                                        <input class="form-control" value="{{ auth()->user()->guru->NipNips }}"
                                            type="text" placeholder="NipNips" id="NipNips" name="NipNips" oninput="this.value = this.value.replace(/[^0-9]/g, '');"  maxlength="16" required>
                                        @error('NipNips')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
                                    @else
                                        <input class="form-control" value="0" type="text"
                                            id="NipNips" name="NipNips">
                                    @endif
...
{{-- hanya angka oninput="this.value = this.value.replace(/[^0-9]/g, '');"  maxlength="16" --}}
                                ...
                                <div class="@error('Nuptk')border border-danger rounded-3 @enderror">
                                    @if (auth()->check() && auth()->user()->guru && auth()->user()->guru->Nuptk)
                                        <input class="form-control" value="{{ auth()->user()->guru->Nuptk }}"
                                            type="text" placeholder="Nuptk" id="Nuptk" name="Nuptk" oninput="this.value = this.value.replace(/[^0-9]/g, '');"  maxlength="16"  required>
                                        @error('Nuptk')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
                                    @else
                            ...
                            <div class="form-group">
                                ...
                                <div class="@error('Nik')border border-danger rounded-3 @enderror">
                                    ...
                                    <input class="form-control" value="{{ auth()->user()->guru->Nik }}"
                                        type="text" placeholder="Nik" id="Nik" name="Nik" oninput="this.value = this.value.replace(/[^0-9]/g, '');"  maxlength="16"  required>
                                    @error('Nik')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                                @else
                                ...
                                <div class="@error('Npwp')border border-danger rounded-3 @enderror">
                                    @if (auth()->check() && auth()->user()->guru && auth()->user()->guru->Npwp)
                                        <input class="form-control" value="{{ auth()->user()->guru->Npwp }}"
                                            type="text" placeholder="Npwp" id="Npwp" name="Npwp"oninput="this.value = this.value.replace(/[^0-9]/g, '');"  maxlength="16" required>
                                        @error('Npwp')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
                                    @else
                                ...
                                <div class="@error('NomorSertifikatPendidik')border border-danger rounded-3 @enderror">
                                    @if (auth()->check() && auth()->user()->guru)
                                        <input class="form-control"
                                            ...
                                            name="NomorSertifikatPendidik"oninput="this.value = this.value.replace(/[^0-9]/g, '');"  maxlength="16" required>
                                        @error('NomorSertifikatPendidik')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
                                    @else
                                        <input class="form-control" value="0" type="text"
                                            placeholder="NomorSertifikatPendidik" id="NomorSertifikatPendidik" name="NomorSertifikatPendidik">
                                    @endif
                                ...
                                <div class="@error('TahunSertifikasi')border border-danger rounded-3 @enderror">
                                    ...
                                    @else
                                        <input class="form-control"  type="date"
                                            id="TahunSertifikasi" name="TahunSertifikasi">
                                    @endif
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('jadwalkenaikangaji')border border-danger rounded-3 @enderror">
                                    ...
                                    @else
                                        <input class="form-control" value="tidak ada data" type="text"
                                            placeholder="jadwalkenaikangaji" id="jadwalkenaikangaji" name="jadwalkenaikangaji">
                                    @endif
                                ...
                                <div class="@error('TahunTamat')border border-danger rounded-3 @enderror">
                                    @if (auth()->check() && auth()->user()->guru)
                                        <input class="form-control" value="{{ auth()->user()->guru->TahunTamat }}"
                                            type="date" placeholder="TahunTamat" id="TahunTamat" name="TahunTamat" required>
                                        @error('TahunTamat')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
                                    @else
                                ...
                                <div class="@error('Jurusan')border border-danger rounded-3 @enderror">
                                    @if (auth()->check() && auth()->user()->guru && auth()->user()->guru->Jurusan)
                                        <input class="form-control" value="{{ auth()->user()->guru->Jurusan }}"
                                            type="text" placeholder="Jurusan" id="Jurusan" name="Jurusan" maxlength="50" required>
                                        @error('Jurusan')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
                                    @else
                            ...
                            <div class="@error('TugasMengajar')border border-danger rounded-3 @enderror">
                                @if (auth()->check() && auth()->user()->guru && auth()->user()->guru->TugasMengajar)
                                    <input class="form-control" value="{{ auth()->user()->guru->TugasMengajar }}"
                                        ...
                                        name="TugasMengajar" maxlength="50" oninput="this.value = this.value.replace(/[^A-Za-z\s]/g, '');" required>
                                    @error('TugasMengajar')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                                @else
                                    <input class="form-control"  type="text"
                                        id="TugasMengajar" value="tidak ada data" name="TugasMengajar">
                                @endif
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="Pangkat"
                                class="form-control-label">{{ __('Pangkat') }}</label>
                            <div class="@error('Pangkat')border border-danger rounded-3 @enderror">
                                @if (auth()->check() && auth()->user()->guru && auth()->user()->guru->Pangkat)
                                    <input class="form-control" value="{{ auth()->user()->guru->Pangkat }}"
                                        type="text" placeholder="Pangkat" id="Pangkat"
                                        name="Pangkat" maxlength="50" required>
                                    @error('Pangkat')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                                @else
                                    <input class="form-control"  type="text"
                                        id="Pangkat" value="tidak ada data"name="Pangkat">
                                @endif
                                ...
                                <div class="@error('Jabatan')border border-danger rounded-3 @enderror">
                                    @if (auth()->check() && auth()->user()->guru && auth()->user()->guru->Jabatan)
                                        <input class="form-control" value="{{ auth()->user()->guru->Jabatan }}"
                                            type="text" placeholder="Jabatan" id="Jabatan" name="Jabatan" maxlength="50" required>
                                        @error('Jabatan')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
                                    @else
                            ...
                            <div class="@error('NomorTelephone')border border-danger rounded-3 @enderror">
                                @if (auth()->check() && auth()->user()->guru && auth()->user()->guru->NomorTelephone)
                                    <input class="form-control" value="{{ auth()->user()->guru->NomorTelephone }}"
                                        ...
                                        name="NomorTelephone" maxlength="13"   oninput="this.value = this.value.replace(/[^0-9]/g, '');" required>
                                    @error('NomorTelephone')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                                @else
                                    <input class="form-control"  type="phone"
                                        id="NomorTelephone" value="0"name="NomorTelephone">
                                @endif
                                ...
                                <div class="@error('Alamat')border border-danger rounded-3 @enderror">
                                    @if (auth()->check() && auth()->user()->guru && auth()->user()->guru->Alamat)
                                        <input class="form-control" value="{{ auth()->user()->guru->Alamat }}"
                                            type="text" placeholder="Alamat" id="Alamat" name="Alamat" maxlength="50" required>
                                        @error('Alamat')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
                                    @else
                            ...
                            <div class="@error('Email')border border-danger rounded-3 @enderror">
                                ...
                                @else
                                    <input class="form-control"  type="email"
                                        id="Email" value="tidak ada data"name="Email">
                                @endif
                            ...
                            <div class="form-group">
                                ...
                                @if (auth()->check() && auth()->user()->guru)
                                    <select class="form-control" name="status" id="status" required>
                                        ...
                                        <option value="Aktif"
                                            {{ auth()->user()->guru->status == 'Aktif' ? 'selected' : '' }}>Aktif</option>
                                        <option value="Tidak Aktif"
                                            {{ auth()->user()->guru->status == 'Tidak Aktif' ? 'selected' : '' }}>Tidak
                                            Aktif</option>
                                ...
                                @else
                                    <input class="form-control" value="tidak ada data" type="text"
                                        placeholder="Agama" id="Agama" name="Agama">
                                @endif
