...
@section('title', 'Kemara-ES | Tambah Informasi')
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">{{ __('Buat Informasi') }}</div>
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form method="POST" id="create-user-form" action="{{ route('Informasi.store') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
