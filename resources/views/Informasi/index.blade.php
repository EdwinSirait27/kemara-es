...
@section('title', ' Kemara-es| Informasi PPDN')
        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header pb-0">
                    ...
                    <h6><i class="fas fa-user-shield"></i> Data Informasi</h6>
                ...
                <div class="card-body px-0 pt-0 pb-2">
                    <div class="table-responsive p-0">
                        ...
                        <button type="button" onclick="window.location='{{ route('Informasi.create') }}'"
    ...
    <script>
        $(document).ready(function() {
            let table = $('#users-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('informasi.informasi') }}',
                lengthMenu: [
                    [10, 25, 50, 100, -1],
                    [10, 25, 50, 100, "All"]
                ],
...
// },

                    {
                            ...
                            render: function(data, type, full, meta) {
                                if (data) {
                                    return '<img src="' + '{{ asset('storage/informasippdb') }}/' + data +
                                        '" width="100" />';
                                } else {
            ...
            $('#delete-selected').on('click', function() {
                ...
                if (selectedIds.length === 0) {
                    Swal.fire({
                        icon: 'warning',
                        title: 'Tidak Ada informasi Yang Dipilih',
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            error: function(xhr) {
                                Swal.fire(
                                    'Error!',
                                    'An error occurred while deleting informasi.',
                                    'error'
                                );
