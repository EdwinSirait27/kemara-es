        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header pb-0">
                    ...
                    <h6><i class="fas fa-user-shield"></i> Data Youtube</h6>
                ...
                <div class="card-body px-0 pt-0 pb-2">
                    <div class="table-responsive p-0">
                        ...
                        <button type="button" onclick="window.location='{{ route('Youtube.create') }}'"
