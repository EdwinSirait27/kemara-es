...
@section('content')
@section('title', 'Kemara-ES | Edit Ekstrakulikuler')
            ...
            <div class="container-fluid py-4">
                <div class="card">
                    <div class="card-header pb-0 px-3">
                        <h6 class="mb-0">{{ __('Edit Ekstrakulikuler') }}</h6>
                    </div>
                    <div class="card-body pt-4 p-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="text" class="form-control" id="namaekstra" name="namaekstra"
                                        value="{{ old('namaekstra', $ekstrakulikuler->namaekstra) }}" required
                                         maxlength="50">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="@error('status') border border-danger rounded-3 @enderror">
                                        <select class="form-control" name="status" id="status" required>
                                            <option value="" disabled {{ old('status', $ekstrakulikuler->status ?? '') == '' ? 'selected' : '' }}>Pilih Status</option>
                                            <option value="Aktif" {{ old('status', $ekstrakulikuler->status ?? '') == 'Aktif' ? 'selected' : '' }}>Aktif</option>
                                            <option value="Tidak Aktif" {{ old('status', $ekstrakulikuler->status ?? '') == 'Tidak Aktif' ? 'selected' : '' }}>Tidak Aktif</option>
                                        </select>
                                        @error('status')
                        ...
                        <div class="d-flex justify-content-end">
                            ...
                            <a href="{{ route('Ekstrakulikuler.index') }}" class="btn btn-secondary mt-4 mb-4">
                                {{ __('Cancel') }}
                            </a>
                        </div>
