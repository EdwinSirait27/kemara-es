...
@section('content')
@section('title', 'Kemara-ES | Edit sekolah')
...
<div>
    <div class="container-fluid">
        ...
        <form action="{{ route('Sekolah.update', $hashedId) }}" method="POST"enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="container-fluid py-4">
                <div class="card">
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="text" class="form-control" id="header" name="header"
                                            value="{{ old('header', $sekolah->header) }}" required maxlength="255">
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <textarea 
                                            ...
                                            required
                                            style="resize: both; overflow: auto;">{{ e($sekolah->body ?? '') }}</textarea>
                                        @error('body')
                                    ...
                                    <div class="@error('status') border border-danger rounded-3 @enderror">
                                        <select class="form-control" name="status" id="status" required>
                                            <option value="" disabled
                                                {{ old('status', $sekolah->status ?? '') == '' ? 'selected' : '' }}>
                                                Pilih Status</option>
                                            <option value="Aktif"
                                                {{ old('status', $sekolah->status ?? '') == 'Aktif' ? 'selected' : '' }}>
                                                Aktif</option>
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        <a href="{{ route('Sekolah.index') }}" class="btn btn-secondary mt-4 mb-4">
                            {{ __('Cancel') }}
                        </a>
                    </div>
