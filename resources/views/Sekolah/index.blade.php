            ...
            <div class="card mb-4">
                ...
                <div class="card-body px-0 pt-0 pb-2">
                    <div class="table-responsive p-0">
                        ...
                        <button type="button" onclick="window.location='{{ route('Sekolah.create') }}'"
...
// },

                    {
                            ...
                            render: function(data, type, full, meta) {
                                if (data) {
                                    return '<img src="' + '{{ asset('storage/sekolah') }}/' + data +
                                        '" width="100" />';
                                } else {
            ...
            $('#delete-selected').on('click', function() {
                ...
                if (selectedIds.length === 0) {
                    Swal.fire({
                        icon: 'warning',
                        title: 'Tidak Ada sekolah Yang Dipilih',
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            error: function(xhr) {
                                Swal.fire(
                                    'Error!',
                                    'An error occurred while deleting sekolah.',
                                    'error'
                                );
