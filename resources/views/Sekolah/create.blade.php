...
@section('title', 'Kemara-ES | Tambah Profile Sekolah')
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">{{ __('Buat Profile Sekolah') }}</div>
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form method="POST" id="create-user-form" action="{{ route('Sekolah.store') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
