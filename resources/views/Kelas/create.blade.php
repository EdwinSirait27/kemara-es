...
@section('title', 'Kemara-ES | Tambah Kelas')
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">{{ __('Buat Kelas') }}</div>
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" id="create-user-form" action="{{ route('Kelas.store') }}">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="@error('kelas')border border-danger rounded-3 @enderror">
                                            ...
                                            value="{{ e($kelas ?? '') }}"
                                            type="text"
                                                id="kelas" name="kelas" aria-describedby="info-kelas"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="@error('tahunakademik_id')border border-danger rounded-3 @enderror">
                                            <select name="tahunakademik_id" id="tahunakademik_id" class="form-select">
                                                <option value="" selected disabled>Pilih Tahunakademik</option>
                                                @foreach ($tahuns as $tahun)
                                                    <option value="{{ $tahun->id }}">{{ $tahun->id }}-{{ $tahun->tahunakademik }}</option>
                                                @endforeach
                                            </select>
