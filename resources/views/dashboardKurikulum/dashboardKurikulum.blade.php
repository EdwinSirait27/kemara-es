...
@section('title', 'Kemara-ES | Dashboard Kurikulum')
@section('content')
    <style>
        .chart-canvas {
            display: block;
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="d-flex flex-column h-100">
                                <h5 class="font-weight-bolder">Kemara-ES | Dashboard kurikulum</h5>
    ...
    <div class="row mt-4">
        <div class="col-lg-5 mb-lg-0 mb-4">
            <div class="card z-index-2">
                {{-- <div class="card-body p-3"> --}}
                <!-- Bagian yang diganti -->
                {{-- <div class="border-radius-lg py-3 pe-1 mb-2"> --}}
                {{-- <div class="card-body"> --}}
                ...
                {{-- <form action="{{ route('dashboardAdmin.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-4">
