...
@endif
            ...
            <li class="nav-item">
              <a class="nav-link" data-bs-toggle="collapse" href="#laravelExamples1" role="button"
                  ...
                  <div
                      class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                      <i class="fas fa-database"></i> <!-- Mengganti dengan ikon database -->
                  </div>
          ...
          @endif
            ...
            <li class="nav-item">
              <a class="nav-link" data-bs-toggle="collapse" href="#laravelExamples2" role="button"
                  ...
                  <div
                      class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                      <i class="fas fa-users"></i> <!-- Mengganti dengan ikon database -->
                  </div>
          ...
          <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="#laravelExamples3" role="button"
                ...
                <div
                    class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    <i class="fas fa-layer-group"></i> <!-- Mengganti dengan ikon database -->
                </div>
    ...
    @endif
    @if (Gate::allows('isAdmin')|| Gate::allows('isKepalaSekolah')|| Gate::allows('isKurikulum'))
    ...
    <li class="nav-item">
      <a class="nav-link" data-bs-toggle="collapse" href="#laravelExamples4" role="button"
          ...
          <div
              class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fas fa-female"></i> <!-- Mengganti dengan ikon database -->
          </div>
...
@endif
@if (Gate::allows('isGuru')|| Gate::allows('isSiswa'))
    <li class="nav-item">
        <a class="nav-link {{ Request::is('daftarsiswa') ? 'active' : '' }}"
            href="{{ url('daftarsiswa') }}">
            <div
                class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
...
<li class="nav-item">
  <a class="nav-link" data-bs-toggle="collapse" href="#laravelExamples5" role="button"
      ...
      <div
          class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
          <i class="fas fa-download"></i> <!-- Mengganti dengan ikon database -->
      </div>
