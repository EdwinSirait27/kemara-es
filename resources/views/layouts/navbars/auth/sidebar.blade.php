...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3" id="sidenav-main">
  <div class="sidenav-header">
    <!-- Tombol Close untuk tampilan mobile -->
  ...
  @endcan
    ...
    <small class="d-block font-weight-bold"style="font-size: 0.9em; margin-left: 15px;"> Selamat Datang, {{ auth()->user()->Username }}</small> 
     <small class="text-muted"style="font-size: 0.8em; margin-left: 15px;">Hak Akses :{{ auth()->user()->hakakses }}</small>
  <hr class="horizontal dark mt-0">
  <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link" data-bs-toggle="collapse" href="#laravelExamples" role="button" aria-expanded="false" aria-controls="laravelExamples">
            ...
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              ...
              <span class="nav-link-text ms-1">Profile tes</span>
          ...
          <li class="nav-item">
              {{-- <a class="nav-link {{ (Request::is('dashboard') ? 'active' : '') }}" href="{{ url('dashboard') }}"> --}}
                {{-- <a class="nav-link {{ (Request::is('dashboard') ? 'active' : '') }}" href="{{ 
                  auth()->user()->hakakses == 'Admin' ? route('dashboardSU') : 
                  (auth()->user()->hakakses == 'Guru' ? route('guru.dashboard') : 
                  (auth()->user()->hakakses == 'Siswa' ? route('siswa.dashboard') : route('login'))) 
              }}">
                  Dashboard
              </a> --}}
                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
