        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header pb-0">
                    ...
                    <h3><i class="fas fa-user-shield"></i> Daftar Siswa Kelas {{$lihat->Pengaturankelas->Kelas->kelas}}</h6>
                        <h4>Wali Kelas : {{$lihat->Pengaturankelas->Kelas->Guru->Nama}}</h4>
                        <h4>Kapasitas Kelas: {{$lihat->Pengaturankelas->Kelas->kapasitas}} Siswa</h4>
                        @endforeach
                    <h4>Jumlah saat ini : {{$jumlahsiswa}} Siswa </h4> 
                                            <br>
<br>
                </div>
