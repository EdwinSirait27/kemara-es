        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="d-flex flex-column h-100">
              ...
              {{-- <img src="{{ asset('assets/img/50204458.jpg') }}" class="navbar-brand-img" style="height: 40px; width: 40px;" alt="Logo"> --}}
              <p class="mb-1 pt-2 text-bold">Selamat datang di Sistem Informasi Akademik SMPK Kesuma Mataram</p>
              <p class=" mb-4" style="text-align: justify;">
                Sistem Informasi Akademik Kemara-ES adalah platform yang dirancang khusus untuk memfasilitasi data
                ...
                dan
                akuntabilitas dalam pengelolaan pendidikan. Dengan Sistem Informasi Akademik Kemara-ES, sekolah dapat
