                                ...
                                <div class="col-12-md-4 col-sm-6">
                                    <div class="osis-card">
                                        <div class="image view view-first">
                                                <img src="{{ asset('storage/organisasi/' . $organ->foto) }}" 
                                                alt="Foto {{ $organ->namaorganisasi }}" 
                                                class="zoomable-image" />
                                           

                                        </div>
                                        <div class="caption">
                                            <p><strong>Organisasi:</strong> {{ $organ->namaorganisasi }}</p>
                                            <p><strong>Keterangan:</strong> {{ $organ->ket }}</p>
                                            <p><strong>Kapasitas:</strong> {{ $organ->kapasitas }}</p>
    ...
    <div class="container mt-4">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card shadow-lg">
                    <div class="card-header bg- text-white">
                        <h5 class="mb-0">List Oerganisasi Anda</h5>
                    </div>
