...
class DashboardControllerKurikulum extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboardKurikulum.dashboardKurikulum', compact('totaluser', 'totallaki', 'totalperempuan', 'totalguru', 'katolik', 'kristen', 'islam', 'hindu', 'buddha', 'kong','pengumuman'));
    }
